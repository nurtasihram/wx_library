...
//inline bool _try_method(const AnyBlock& block) {
//	try {
//		block(ctx, )
//	}
//}
...
static void load_duk_module(duk_context *ctx) {
	//duk_struct_global(ctx, "ModuleObj", [](duk_context *ctx) -> duk_ret_t {
	//	duk_method(ctx, "Menu", 1, [](duk_context *ctx) -> duk_ret_t {
	//		auto &&mod = reuse_as<Module>(duk_member_handle(ctx));
	//		if (!mod)
	//			return DUK
	//		if (wx_try(ctx, [&]() { mod.Menu(); }))
...
static void load_duk_pen(duk_context *ctx) {
	duk_struct_global(ctx, "PenObj", [](duk_context *ctx) -> duk_ret_t {
		return 0;
	});
}

static void load_duk_brush(duk_context *ctx) {
	duk_struct_global(ctx, "BrushObj", [](duk_context *ctx) -> duk_ret_t {
		return 0;
	});
}
...
static void load_duk_menu(duk_context *ctx) {
	...
	*/
	//duk_get_context
	duk_struct_global(ctx, "MenuObj", [](duk_context *ctx) {
	...
	duk_function_global(ctx, "Menu", [](duk_context *ctx) {
...
static void load_duk_devcap(duk_context *ctx) {
	duk_struct_global(ctx, "DevCapObj", [](duk_context *ctx) -> duk_ret_t {
