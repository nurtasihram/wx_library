...
static void load_duk_pen(duk_context *ctx) {
	...
	duk_add_class(
		...
		duk_static {
			...
			/* Pen */ duk_add_prop_r(ctx, "White", duk_fn {
				CPen pen = O;
			...
			/* Pen */ duk_add_prop_r(ctx, "Black", duk_fn {
				CPen pen = O;
			...
			/* Pen */ duk_add_prop_r(ctx, "Null", duk_fn {
				CPen pen = O;
			...
			/* Pen */ duk_add_prop_r(ctx, "DC", duk_fn {
				CPen pen = O;
...
static void load_duk_brush(duk_context *ctx) {
	...
	duk_add_class(
		...
		duk_static {
			...
			/* Brush */ duk_add_prop_r(ctx, "White", duk_fn {
				CBrush brush = O;
			...
			/* Brush */ duk_add_prop_r(ctx, "LitGray", duk_fn {
				CBrush brush = O;
			...
			/* Brush */ duk_add_prop_r(ctx, "Gray", duk_fn {
				CBrush brush = O;
			...
			/* Brush */ duk_add_prop_r(ctx, "DkGray", duk_fn {
				CBrush brush = O;
			...
			/* Brush */ duk_add_prop_r(ctx, "Black", duk_fn {
				CBrush brush = O;
			...
			/* Brush */ duk_add_prop_r(ctx, "Null", duk_fn {
				CBrush brush = O;
			...
			/* Brush */ duk_add_prop_r(ctx, "DC", duk_fn {
				CBrush brush = O;
...
static void load_duk_devcap(duk_context *ctx) {
	...
	duk_add_class(
		...
		duk_structure {
			...
			/* Point */ duk_add_prop_r(ctx, "Size", duk_fn {
				auto pobj = duk_get_this__p<CDevCap>(ctx);
				if (!pobj) return DUK_RET_TYPE_ERROR;
				LPoint size;
			...
			///* uint */ duk_add_prop_r(ctx, "PaletteRealize", duk_fn {
			//	auto pobj = duk_get_this__p<CDevCap>(ctx);
			//	if (!pobj)
			//		return DUK_RET_TYPE_ERROR;
			//	duk_uint_t size = 0;
